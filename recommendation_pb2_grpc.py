...
class RecommendationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRecommendations = channel.unary_unary(
                '/proto.RecommendationService/GetRecommendations',
...
def add_RecommendationServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'proto.RecommendationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('proto.RecommendationService', rpc_method_handlers)
